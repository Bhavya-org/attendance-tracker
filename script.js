...
// Global constants - USE SINGLE SHARED KEY FOR ALL DATA
...
// Save shared attendance data
function saveSharedData(attendanceData) {
    try {
        localStorage.setItem(SHARED_DATA_KEY, JSON.stringify(attendanceData));
